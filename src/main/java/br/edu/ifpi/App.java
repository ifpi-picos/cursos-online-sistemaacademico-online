...
public class App {
    public static void main(String[] args) {
        ...
        int deleta = ProfessorDao.remover(novoProfessor);
         ...
         JOptionPane.showMessageDialog(null, msm3, "deu certo emy", JOptionPane.INFORMATION_MESSAGE);
       ...
       int deletar = ProfessorDao.remover(8);
       String msg = deleta > 0 ? "deu certo" : "nao deu";
       JOptionPane.showMessageDialog(null, msg, "Deu certo emy",
        JOptionPane.INFORMATION_MESSAGE);
    }
}
